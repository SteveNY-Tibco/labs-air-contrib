module github.com/SteveNY-Tibco/labs-air-contrib/common/graphbuilder/dbservice

go 1.14

require (
	github.com/SteveNY-Tibco/labs-air-contrib/common/graphbuilder/model v0.0.0-20211006182410-78f7f5be994e
